...
func (f *fakeRedis) XReadGroup(ctx context.Context, a *redis.XReadGroupArgs) *redis.XStreamSliceCmd { var cmd redis.XStreamSliceCmd; return &cmd }
...
func (f *fakeRedis) XAutoClaim(ctx context.Context, a *redis.XAutoClaimArgs) *redis.XAutoClaimCmd { var cmd redis.XAutoClaimCmd; return &cmd }

func (f *fakeRedis) XLen(ctx context.Context, stream string) *redis.IntCmd { return redis.NewIntCmd(ctx) }

func (f *fakeRedis) XPending(ctx context.Context, stream, group string) *redis.XPendingCmd { var cmd redis.XPendingCmd; return &cmd }

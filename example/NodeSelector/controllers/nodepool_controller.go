...
//+kubebuilder:rbac:groups=nodes.kubecli.io,resources=nodepools,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=nodes.kubecli.io,resources=nodepools/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=nodes.kubecli.io,resources=nodepools/finalizers,verbs=update
